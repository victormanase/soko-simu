...
public class CategoryProductsLoader implements Response.Listener<JSONArray>, Response.ErrorListener {
    ...
    public CategoryProductsLoader(HomeProductsAdapter hpa, List<Product> p, Context ctx, ProgressBar prg, int i){
    ...
    public void GetProducts(){
        ...
        String url = Urls.CATEGORIES + id  + "?api_token="+ssPreferences.getString(SharedPrefKeys.API_TOKEN, SharedPrefDefaults.API_TOKEN);
