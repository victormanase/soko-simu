...
public class CartProductsAdapter extends RecyclerView.Adapter<CartProductsAdapter.viewHolder> {
    ...
    public CartProductsAdapter(List<Product> p, int RootLayoutId){
        this.products = p;
        rootLayoutId = RootLayoutId;
    }

    @Override
    public CartProductsAdapter.viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_cart,parent,false);
        return new viewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(CartProductsAdapter.viewHolder holder, final int position) {
