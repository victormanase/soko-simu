...
public class HomeProductsAdapter extends RecyclerView.Adapter<HomeProductsAdapter.viewHolder> {
    ...
    public HomeProductsAdapter(List<Product> p, int RootLayoutId){
        this.products = p;
        rootLayoutId = RootLayoutId;
    }

    @Override
    public HomeProductsAdapter.viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.product,parent,false);
        return new viewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(HomeProductsAdapter.viewHolder holder, final int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("time",product.productTime);
                int imgCount = 0;
